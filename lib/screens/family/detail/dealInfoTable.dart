...
class DealInfoPageTable extends StatefulWidget {
  final String elementId;
  final String ownerAvatar;
  final String label;

  const DealInfoPageTable(
      {Key? key,
  ...
  @override
  _DealInfoPageTableState createState() => _DealInfoPageTableState();
}

class _DealInfoPageTableState extends State<DealInfoPageTable> {
